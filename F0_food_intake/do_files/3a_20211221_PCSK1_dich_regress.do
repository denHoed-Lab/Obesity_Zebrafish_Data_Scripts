...
** Examine the effect of mutations in pcsk1 adjusted for tank, batch (in residuals) and tod (all larvae are 8dpf)
use "DATA/food_intake/205_PCSK1/PCSK1_for_analysis.dta", clear
* 8 dpf

foreach outcome in intlength intIntestine_area {

preserve
regress `outcome' i.pcsk1_dich i.batch i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace
restore
}
...
preserve
regress `outcome' i.pcsk1_dich length i.batch i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace
...
preserve
regress `outcome' i.pcsk1_dich pos_bio i.batch_bio i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace
...
preserve
mlogit `outcome' i.pcsk1_dich i.f_batch i.batch i.tank tod, rrr baseoutcome(2)
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`outcome'_est", replace
...
* now append
clear
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/pcsk1_dich_batch.dta", replace emptyok 
...
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/`file'", clear
gen model="`file'"
append using "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/pcsk1_dich_batch.dta"
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/pcsk1_dich_batch.dta", replace
}
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_batch/pcsk1_dich_batch.dta", clear
...
save "RESULTS/food_intake/205_PCSK1/fixed_effects_f0_pcsk1_dich_batch.dta", replace
export excel using "RESULTS/food_intake/205_PCSK1/fixed_effects_f0_pcsk1_dich_batch.xls", replace firstrow(variables)
...
preserve
regress `outcome' i.pcsk1_dich length dorsal_area i.batch i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/`outcome'_est", replace)
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/`outcome'_est", replace
restore
}
...
preserve
regress `outcome' i.pcsk1_dich length dorsal_area pos_bio i.batch_bio i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/`outcome'_est", replace)
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/`outcome'_est", replace
...
* now append
clear
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/pcsk1_dich_size.dta", replace emptyok 

foreach file in /*intldl_est inttg_est inttc_est intgluc_est*/ ///
intIntestine_area_est {

use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/`file'", clear
gen model="`file'"
append using "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/pcsk1_dich_size.dta"
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/pcsk1_dich_size.dta", replace
}
use "RESULTS/food_intake/205_PCSK1/pcsk1_dich_size/pcsk1_dich_size.dta", clear
drop if strpos(parm,"b.")
drop if strpos(parm,"o.")
drop dof
egen id=concat(parm) if parm=="_cons"
...
save "RESULTS/food_intake/205_PCSK1/fixed_effects_f0_pcsk1_dich_size.dta", replace
export excel using "RESULTS/food_intake/205_PCSK1/fixed_effects_f0_pcsk1_dich_size.xls", replace firstrow(variables)
...
use "RESULTS/food_intake/205_PCSK1/fixed_effects_f0_pcsk1_dich_batch.dta", clear
merge 1:1 trait model eq parm using "RESULTS/food_intake/205_PCSK1/fixed_effects_f0_pcsk1_dich_size.dta"
drop _merge
...
outsheet using "RESULTS/food_intake/205_PCSK1/pcsk1_dich_results.txt", noquote replace
save "RESULTS/food_intake/205_PCSK1/pcsk1_dich_results.dta", replace
outsheet using "/Users/marde358/Desktop/Projects/Novo_screen/OUTPUT/sumstats/Food_intake/pcsk1_dich_results.txt", noquote replace
