...
** Examine the effect of mutations in mc4r adjusted for tank, batch (in residuals) and tod (all larvae are 8dpf)
use "DATA/food_intake/100_MC4R/MC4R_for_analysis.dta", clear
* 8 dpf

foreach outcome in intlength intIntestine_area {

preserve
regress `outcome' i.mc4r_dich i.batch i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace
restore
}
...
preserve
regress `outcome' i.mc4r_dich length i.batch i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace
...
preserve
regress `outcome' i.mc4r_dich pos_bio i.batch_bio i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace
...
preserve
mlogit `outcome' i.mc4r_dich i.f_batch i.batch i.tank tod, rrr baseoutcome(2)
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace)
use "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`outcome'_est", replace
...
* now append
clear
save "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/mc4r_dich_batch.dta", replace emptyok 
...
use "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/`file'", clear
gen model="`file'"
append using "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/mc4r_dich_batch.dta"
save "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/mc4r_dich_batch.dta", replace
}
use "RESULTS/food_intake/100_MC4R/mc4r_dich_batch/mc4r_dich_batch.dta", clear
...
save "RESULTS/food_intake/100_MC4R/fixed_effects_f0_mc4r_dich_batch.dta", replace
export excel using "RESULTS/food_intake/100_MC4R/fixed_effects_f0_mc4r_dich_batch.xls", replace firstrow(variables)
...
** Examine the effect of mutations in mc4r additionally adjusted for size
use "DATA/food_intake/100_MC4R/MC4R_for_analysis.dta", clear
set more off
...
preserve
regress `outcome' i.mc4r_dich length dorsal_area i.batch i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/100_MC4R/mc4r_dich_size/`outcome'_est", replace)
use "RESULTS/food_intake/100_MC4R/mc4r_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/100_MC4R/mc4r_dich_size/`outcome'_est", replace
restore
}
...
preserve
regress `outcome' i.mc4r_dich length dorsal_area pos_bio i.batch_bio i.tank tod
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/food_intake/100_MC4R/mc4r_dich_size/`outcome'_est", replace)
use "RESULTS/food_intake/100_MC4R/mc4r_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/food_intake/100_MC4R/mc4r_dich_size/`outcome'_est", replace
...
* now append
clear
save "RESULTS/food_intake/100_MC4R/mc4r_dich_size/mc4r_dich_size.dta", replace emptyok 

foreach file in /*intldl_est inttg_est inttc_est intgluc_est*/ ///
intIntestine_area_est {

use "RESULTS/food_intake/100_MC4R/mc4r_dich_size/`file'", clear
gen model="`file'"
append using "RESULTS/food_intake/100_MC4R/mc4r_dich_size/mc4r_dich_size.dta"
save "RESULTS/food_intake/100_MC4R/mc4r_dich_size/mc4r_dich_size.dta", replace
}
use "RESULTS/food_intake/100_MC4R/mc4r_dich_size/mc4r_dich_size.dta", clear
drop if strpos(parm,"b.")
drop if strpos(parm,"o.")
drop dof
egen id=concat(parm) if parm=="_cons"
...
gen eq = ""
save "RESULTS/food_intake/100_MC4R/fixed_effects_f0_mc4r_dich_size.dta", replace
export excel using "RESULTS/food_intake/100_MC4R/fixed_effects_f0_mc4r_dich_size.xls", replace firstrow(variables)
...
use "RESULTS/food_intake/100_MC4R/fixed_effects_f0_mc4r_dich_batch.dta", clear
merge 1:1 trait model eq parm using "RESULTS/food_intake/100_MC4R/fixed_effects_f0_mc4r_dich_size.dta"
drop _merge
...
gen order = .
replace order = 1 if strpos(parm,"1.mc4r_dich")
...
replace parm = "mc4r_dich" if parm == "1.mc4r_dich"
...
outsheet using "RESULTS/food_intake/100_MC4R/mc4r_dich_results.txt", noquote replace
save "RESULTS/food_intake/100_MC4R/mc4r_dich_results.dta", replace
outsheet using "/Users/marde358/Desktop/Projects/Novo_screen/OUTPUT/sumstats/Food_intake/mc4r_dich_results.txt", noquote replace
