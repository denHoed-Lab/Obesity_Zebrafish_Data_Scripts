...
preserve
nbreg `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_un_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/`outcome'_est", replace
restore
}
...
preserve
logit `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_un_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/`outcome'_est", replace
...
* now append
clear
save "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/exposure_pop1_2_add_score1_un_sensitivity.dta", replace emptyok 

foreach file in bld_est bodyfat_est {

use "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/`file'", clear
gen model="`file'"
append using "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/exposure_pop1_2_add_score1_un_sensitivity.dta"
save "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/exposure_pop1_2_add_score1_un_sensitivity.dta", replace
}
use "RESULTS/exposure_pop1_2_add_score1_un_sensitivity/exposure_pop1_2_add_score1_un_sensitivity.dta", clear
...
drop id order eq
save "RESULTS/fixed_effects_ob_pop1_2_add_score1_un_sensitivity.dta", replace
export excel using "RESULTS/fixed_effects_ob_pop1_2_add_score1_un_sensitivity.xls", replace firstrow(variables)
...
preserve
regress `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod i.experiment i.batch i.tank
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", replace
restore
}
...
preserve
nbreg `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod i.batch i.experiment
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", replace
...
preserve
logit `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod i.batch i.experiment
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`outcome'_est", replace
...
* now append
clear
save "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/exposure_pop1_2_add_score1_batch_sensitivity.dta", replace emptyok 
...
use "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/`file'", clear
gen model="`file'"
append using "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/exposure_pop1_2_add_score1_batch_sensitivity.dta"
save "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/exposure_pop1_2_add_score1_batch_sensitivity.dta", replace
}
use "RESULTS/exposure_pop1_2_add_score1_batch_sensitivity/exposure_pop1_2_add_score1_batch_sensitivity.dta", clear
drop if strpos(parm,"b.")
drop if strpos(parm,"o.")
drop if eq == "lnalpha"
replace t = z if t == .
...
sort trait model order
drop id order eq
save "RESULTS/fixed_effects_ob_pop1_2_add_score1_batch_sensitivity.dta", replace
export excel using "RESULTS/fixed_effects_ob_pop1_2_add_score1_batch_sensitivity.xls", replace firstrow(variables)
...
preserve
regress `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod length dorsal_area i.experiment i.batch i.tank
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", replace
restore
}
...
preserve
nbreg `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod length dorsal_area i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", replace
...
preserve
logit `outcome' score1 sh2b1_D bdnf_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D tod length dorsal_area i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`outcome'_est", replace
...
* now append
clear
save "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/exposure_pop1_2_add_score1_size_sensitivity.dta", replace emptyok 
...
use "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/`file'", clear
gen model="`file'"
append using "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/exposure_pop1_2_add_score1_size_sensitivity.dta"
save "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/exposure_pop1_2_add_score1_size_sensitivity.dta", replace
}
use "RESULTS/exposure_pop1_2_add_score1_size_sensitivity/exposure_pop1_2_add_score1_size_sensitivity.dta", clear
drop if strpos(parm,"b.")
drop if strpos(parm,"o.")
drop if eq == "lnalpha"
replace t = z if t == .
...
sort trait model order
drop id order eq
save "RESULTS/fixed_effects_ob_pop1_2_add_score1_size_sensitivity.dta", replace
export excel using "RESULTS/fixed_effects_ob_pop1_2_add_score1_size_sensitivity.xls", replace firstrow(variables)
...
use "RESULTS/fixed_effects_ob_pop1_2_add_score1_un_sensitivity.dta", clear
merge 1:1 trait model parm using "RESULTS/fixed_effects_ob_pop1_2_add_score1_batch_sensitivity.dta"
drop _merge
merge 1:1 trait model parm using "RESULTS/fixed_effects_ob_pop1_2_add_score1_size_sensitivity.dta"
drop _merge

gen order = .
replace order = 1 if strpos(parm,"score1")
...
outsheet using "RESULTS/OB1_2_sensitivity/obesity_pop1_2_add_score1_linear_results_sensitivity.txt", noquote replace
