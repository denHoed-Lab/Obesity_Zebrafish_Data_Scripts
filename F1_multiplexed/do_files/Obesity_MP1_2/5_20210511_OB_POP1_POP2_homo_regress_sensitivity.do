...
** Examine the effect of OB POP1+POP2 genes adjusted for tod only
...
rename (lepr_homo mc4r_homo negr1_homo pcsk1_homo pomca_homo irs2b_homo sh2b1_homo sim1b_homo) (xxlepr_homo xxmc4r_homo xnegr1_homo xpcsk1_homo xpomca_homo xirs2b_homo xsh2b1_homo xsim1b_homo)

*local p "i.arid5b_homo          lepr_D mc4r_D negr1_D pcsk1_D pomca_D pomcb_D sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
*local q "i.xxlepr_homo arid5b_D        mc4r_D negr1_D pcsk1_D pomca_D pomcb_D sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
local  r "i.xxmc4r_homo arid5b_D lepr_D        negr1_D pcsk1_D pomca_D pomcb_D sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
local  s "i.xnegr1_homo arid5b_D lepr_D mc4r_D         pcsk1_D pomca_D pomcb_D sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
local  t "i.xpcsk1_homo arid5b_D lepr_D mc4r_D negr1_D         pomca_D pomcb_D sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
*local u "i.xpomca_homo arid5b_D lepr_D mc4r_D negr1_D pcsk1_D         pomcb_D sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
*local v "i.xpomcb_homo arid5b_D lepr_D mc4r_D negr1_D pcsk1_D pomca_D         sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
local  w "i.sec16b_homo arid5b_D lepr_D mc4r_D negr1_D pcsk1_D pomca_D pomcb_D          bdnf_D sh2b1_D irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
local  x "i.xirs2b_homo arid5b_D lepr_D mc4r_D negr1_D pcsk1_D pomca_D pomcb_D sec16b_D bdnf_D sh2b1_D irs1_D irs2a_D         sim1a_D sim1b_D"
local  y "i.xsh2b1_homo arid5b_D lepr_D mc4r_D negr1_D pcsk1_D pomca_D pomcb_D sec16b_D bdnf_D         irs1_D irs2a_D irs2b_D sim1a_D sim1b_D"
local  z "i.xsim1b_homo arid5b_D lepr_D mc4r_D negr1_D pcsk1_D pomca_D pomcb_D sec16b_D bdnf_D irs1_D irs2a_D irs2b_D sh2b1_D sim1a_D        "

foreach loc in "`r'" "`s'" "`t'" "`w'" "`x'" "`y'" "`z'" {
...
preserve
nbreg `outcome' `loc' tod i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_homo_un_sensitivity/`gene'_`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_homo_un_sensitivity/`gene'_`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_homo_un_sensitivity/`gene'_`outcome'_est", replace
restore
}
...
preserve
logit `outcome' `loc' tod i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_homo_un_sensitivity/`gene'_`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_homo_un_sensitivity/`gene'_`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_homo_un_sensitivity/`gene'_`outcome'_est", replace
...
* now append
clear
save "RESULTS/exposure_pop1_2_homo_un_sensitivity/exposure_pop1_2_homo_un_sensitivity.dta", replace emptyok 
...
use "RESULTS/exposure_pop1_2_homo_un_sensitivity/`file'", clear
gen model="`file'"
append using "RESULTS/exposure_pop1_2_homo_un_sensitivity/exposure_pop1_2_homo_un_sensitivity.dta"
save "RESULTS/exposure_pop1_2_homo_un_sensitivity/exposure_pop1_2_homo_un_sensitivity.dta", replace
}

use "RESULTS/exposure_pop1_2_homo_un_sensitivity/exposure_pop1_2_homo_un_sensitivity.dta", clear
...
save "RESULTS/fixed_effects_ob_pop1_2_homo_un_sensitivity.dta", replace
export excel using "RESULTS/fixed_effects_ob_pop1_2_homo_un_sensitivity.xls", replace firstrow(variables)
...
** Examine the effect of OB POP1+POP2 genes adjusted for tod +batch+tank
use "DATA/Obesity_POP1_2_JOINED/OB_POP1_2_for_analysis_sensitivity.dta", clear
set more off
...
preserve
regress `outcome' `loc' tod i.experiment i.batch i.tank
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_homo_batch_sensitivity/`gene'_`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_homo_batch_sensitivity/`gene'_`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_homo_batch_sensitivity/`gene'_`outcome'_est", replace
restore
}
...
* now append
clear
save "RESULTS/exposure_pop1_2_homo_batch_sensitivity/exposure_pop1_2_homo_batch_sensitivity.dta", replace emptyok 
...
sec16b_homo_bld_est sec16b_homo_bodyfat_est ///
xirs2b_homo_intlength_est xirs2b_homo_intdorsal_area_est xirs2b_homo_intlateral_area_est ///
...
xsim1b_homo_bld_est xsim1b_homo_bodyfat_est {
use "RESULTS/exposure_pop1_2_homo_batch_sensitivity/`file'", clear
gen model="`file'"
append using "RESULTS/exposure_pop1_2_homo_batch_sensitivity/exposure_pop1_2_homo_batch_sensitivity.dta"
save "RESULTS/exposure_pop1_2_homo_batch_sensitivity/exposure_pop1_2_homo_batch_sensitivity.dta", replace
}

use "RESULTS/exposure_pop1_2_homo_batch_sensitivity/exposure_pop1_2_homo_batch_sensitivity.dta", clear
keep if strpos(parm,"_homo") | inlist(parm,"_cons")
drop if eq == "lnalpha"
replace t = z if t == .
drop dof z eq
...
save "RESULTS/fixed_effects_ob_pop1_2_homo_batch_sensitivity.dta", replace
export excel using "RESULTS/fixed_effects_ob_pop1_2_homo_batch_sensitivity.xls", replace firstrow(variables)
...
preserve
regress `outcome' `loc' tod length dorsal_area i.experiment i.batch i.tank
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", replace
restore
}
...
preserve
nbreg `outcome' `loc' tod length dorsal_area i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", replace
...
preserve
logit `outcome' `loc' tod length dorsal_area i.experiment i.batch
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", replace)
use "RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", clear
gen N=e(N)
save "RESULTS/exposure_pop1_2_homo_size_sensitivity/`gene'_`outcome'_est", replace
...
* now append
clear
save "RESULTS/exposure_pop1_2_homo_size_sensitivity/exposure_pop1_2_homo_size_sensitivity.dta", replace emptyok 
...
xsim1b_homo_bld_est xsim1b_homo_bodyfat_est ///
{
use "RESULTS/exposure_pop1_2_homo_size_sensitivity/`file'", clear
gen model="`file'"
append using "RESULTS/exposure_pop1_2_homo_size_sensitivity/exposure_pop1_2_homo_size_sensitivity.dta"
save "RESULTS/exposure_pop1_2_homo_size_sensitivity/exposure_pop1_2_homo_size_sensitivity.dta", replace
}

use "RESULTS/exposure_pop1_2_homo_size_sensitivity/exposure_pop1_2_homo_size_sensitivity.dta", clear
keep if strpos(parm,"_homo") | inlist(parm,"_cons")
drop if eq == "lnalpha"
replace t = z if t == .
drop dof z eq
...
save "RESULTS/fixed_effects_ob_pop1_2_homo_size_sensitivity.dta", replace
export excel using "RESULTS/fixed_effects_ob_pop1_2_homo_size_sensitivity.xls", replace firstrow(variables)
...
set more off
use "RESULTS/fixed_effects_ob_pop1_2_homo_un_sensitivity.dta", clear
merge 1:1 trait parm using "RESULTS/fixed_effects_ob_pop1_2_homo_batch_sensitivity.dta"
drop _merge
merge 1:1 trait parm using "RESULTS/fixed_effects_ob_pop1_2_homo_size_sensitivity.dta"
drop _merge
...
replace order = 7 if strpos(parm,"xirs2b_homo")
replace order = 8 if strpos(parm,"xsh2b1_homo")
replace order = 9 if strpos(parm,"xsim1b_homo")
replace order = 10 if strpos(parm,"_cons")
...
replace trait_order = 30 if strpos(trait,"beta_cell_volume")
...
outsheet using "RESULTS/OB1_2_sensitivity/obesity_pop1_2_homo_linear_results_sensitivity.txt", noquote replace
