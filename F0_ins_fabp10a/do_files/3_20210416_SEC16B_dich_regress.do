...
** Examine the effect of mutations in sec16b adjusted for tank (in residuals) and tod and age
use "DATA/F0/1_SEC16B/SEC16B_for_analysis.dta", clear
...
preserve
regress `outcome' i.sec16b_dich tod i.age i.tank
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace
restore
}
...
preserve
regress `outcome' i.sec16b_dich tod i.age i.tank length
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace
...
preserve
regress `outcome' i.sec16b_dich tod i.age i.tank pos_bio i.batch_bio i.Imaged
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace
...
preserve
nbreg `outcome' i.sec16b_dich tod i.age tod i.age
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace
...
preserve
logit `outcome' i.sec16b_dich tod i.age
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`outcome'_est", replace
...
* now append
clear
save "RESULTS/F0/1_SEC16B/sec16b_dich_batch/sec16b_dich_batch.dta", replace emptyok 
...
use "RESULTS/F0/1_SEC16B/sec16b_dich_batch/`file'", clear
gen model="`file'"
append using "RESULTS/F0/1_SEC16B/sec16b_dich_batch/sec16b_dich_batch.dta"
save "RESULTS/F0/1_SEC16B/sec16b_dich_batch/sec16b_dich_batch.dta", replace
}
use "RESULTS/F0/1_SEC16B/sec16b_dich_batch/sec16b_dich_batch.dta", clear
...
save "RESULTS/F0/1_SEC16B/fixed_effects_f0_sec16b_dich_batch.dta", replace
export excel using "RESULTS/F0/1_SEC16B/fixed_effects_f0_sec16b_dich_batch.xls", replace firstrow(variables)
...
preserve
regress `outcome' i.sec16b_dich tod i.age length dorsal_area i.tank
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace
restore
}
...
preserve
regress `outcome' i.sec16b_dich tod i.age length dorsal_area pos_bio i.batch_bio i.Imaged i.tank
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace
...
preserve
nbreg `outcome' i.sec16b_dich tod i.age length dorsal_area
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace
...
preserve
logit `outcome' i.sec16b_dich tod i.age length dorsal_area
parmest, format(estimate %8.6f min95 max95 %8.6f p %8.1e) saving ("RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace)
use "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", clear
gen N=e(N)
save "RESULTS/F0/1_SEC16B/sec16b_dich_size/`outcome'_est", replace
...
* now append
clear
save "RESULTS/F0/1_SEC16B/sec16b_dich_size/sec16b_dich_size.dta", replace emptyok 
...
use "RESULTS/F0/1_SEC16B/sec16b_dich_size/`file'", clear
gen model="`file'"
append using "RESULTS/F0/1_SEC16B/sec16b_dich_size/sec16b_dich_size.dta"
save "RESULTS/F0/1_SEC16B/sec16b_dich_size/sec16b_dich_size.dta", replace
}
use "RESULTS/F0/1_SEC16B/sec16b_dich_size/sec16b_dich_size.dta", clear
drop if strpos(parm,"b.")
drop if strpos(parm,"o.")
drop if eq == "lnalpha"
replace t = z if t == .
...
drop if strpos(parm,"batch")
drop if strpos(parm,"tank")
save "RESULTS/F0/1_SEC16B/fixed_effects_f0_sec16b_dich_size.dta", replace
export excel using "RESULTS/F0/1_SEC16B/fixed_effects_f0_sec16b_dich_size.xls", replace firstrow(variables)
...
use "RESULTS/F0/1_SEC16B/fixed_effects_f0_sec16b_dich_batch.dta", clear
merge 1:1 trait model parm using "RESULTS/F0/1_SEC16B/fixed_effects_f0_sec16b_dich_size.dta"
drop _merge
...
order trait parm beta_batch SE_batch LCI_batch UCI_batch P_batch t_batch N_batch l     beta_size SE_size LCI_size UCI_size P_size t_size N_size

replace parm = "sec16b_dich" if parm == "1.sec16b_dich"

outsheet using "RESULTS/F0/1_SEC16B/sec16b_dich_results.txt", noquote replace
